...
(function (global, factory) {
  ...
  Config._schemeCategory20c = [
    //"#844AE8","#1992FF","#0CE885","#B3FF69","#FF80BD",
    //"#241E26","#34BFA6","#F29441","#F27649","#D94E41",
    //"#151826","#6D7BA6","#A3BFD9","#43D9BD","#3DD9AD",
    "#476088","#7d61e8","#61a8e8", "#4fddc3","#ffc562","#60cf83","#cf60bc","#ff6d74", , "#60cf83"];

    // ["#6d3fa9","#b43cb1","#f5468d","#ff714b","#e4b42e","#b6e64d","#7df558","#1ee0a0","#1db8cf","#348ee1","#5e57ca","#6d40aa"]
  /**
